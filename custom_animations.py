...
video_clip = VideoFileClip("images_and_vids/cmatrix3.mp4")
image_clip = ImageClip("images_and_vids/dog.png").set_duration(video_clip.duration)
...
final_clip.write_videofile("images_and_vids/output_circular.mp4", fps=video_clip.fps)